...
public class GUIController<T>
{
    ...
    /**
	* Overridden to be draw
     */
    public void run()
    {
    	parentFrame.getWorld().draw();
    
    	parentFrame.getWorld().setMessage("You pressed this button because you were going to lose.");
    	parentFrame.setEnabled(false);
